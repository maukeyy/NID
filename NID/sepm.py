...
def llr(clean_speech, processed_speech, fs, frameLen=0.03, overlap=0.75):
    ...
    frac=numerators/(denominators+eps)
    frac[frac<=0]=1000
...
def composite(clean_speech, processed_speech, fs):
    ...
    stoi_ = pystoi.stoi(clean_speech, processed_speech, fs, extended=False)
    ...
    return segSNR, pesq_mos, Csig, Cbak, Covl, stoi_
...
def compareone(args):
    ...
    try:
      ssnr,pesq,csig,cbak,covl,stoi=composite(c,p,fc)
    ...
    return name,csig,cbak,covl,pesq,ssnr,stoi
